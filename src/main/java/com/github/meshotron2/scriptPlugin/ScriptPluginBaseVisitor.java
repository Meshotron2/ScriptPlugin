...
public class ScriptPluginBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements ScriptPluginVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitCreateShape(ScriptPluginParser.CreateShapeContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitInstantiation(ScriptPluginParser.InstantiationContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitCoefficient(ScriptPluginParser.CoefficientContext ctx) { return visitChildren(ctx); }
}