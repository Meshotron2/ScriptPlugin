...
public class ScriptPluginParser extends Parser {
	...
	public static class ModuleContext extends ParserRuleContext {
		...
		public TerminalNode CHAR() { return getToken(ScriptPluginParser.CHAR, 0); }
	...
	public static class ConstructorContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ScriptPluginVisitor ) return ((ScriptPluginVisitor<? extends T>)visitor).visitConstructor(this);
			else return visitor.visitChildren(this);
		}
	}
